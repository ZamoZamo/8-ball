  ...
  document.getElementById('username').onclick = function() {
    ...
    if (name) {
      ...
      if (/^Magic 8-ball$/i.test(name)) {
        magic8.log('', 'HOW DARE YOU TRY AND IMPOSTOR ME ! YOU ARE GONNA CRY OR DYE STILL DECIDING!');
        magic8.log('', 'You know what... I\ will prove you are the "Unmagical 8-ball" and hide the naming button with my magic !');
